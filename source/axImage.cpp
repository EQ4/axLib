...
namespace ax
{
    ...
    bool ImageGlobalMapLoader::LoadImage(const std::string& path,
                                           GLuint& _texture,
                                           ax::Size& _size)
    {
#ifdef _AX_VST_APP_
    ...
    bool ImageGlobalMapLoader::InitImage(const std::string& path,
                                           GLuint& _texture,
                                           ax::Size& _size)
    {
    ...
    Image::Image(void* data, const ax::Size& size):
    _size(size),
    _path("tmp")
    {
        glGenTextures(1, &_texture);
