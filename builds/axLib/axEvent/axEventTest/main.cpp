...
int main(int argc, const char * argv[])
{
    ...
    {
        ax::Event::StringMsg* stringMsg =
                static_cast<ax::Event::StringMsg*>(msg);
    ...
    obj4.AddConnection(0, [](ax::Event::Msg* msg)
                       {
                           ax::Event::SimpleMsg<int>& s_msg =
                                    ax::Event::SimpleMsg<int>::Cast(msg);
                           
                           std::cout << "obj4 event : " <<
                           s_msg.GetMsg() << std::endl;
                       });
